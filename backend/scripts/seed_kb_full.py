"""
Full Knowledge Base Seeder — Ingests all 4 segments (~2991 entries) into the demo property.
Embeddings are generated via Gemini (asyncio.to_thread) or OpenAI fallback.

Segments:
  A: Hotel & Resort          — 19 files, ~1,400 entries
  B: Homestay, Villa, Inn    — 10 files, ~700 entries
  C: Malaysian Festive       —  9 files, ~660 entries
  D: General FAQs            —  1 file,  ~229 entries
